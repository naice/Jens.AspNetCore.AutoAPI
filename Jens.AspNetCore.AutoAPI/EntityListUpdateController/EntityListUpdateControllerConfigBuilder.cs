...
public class EntityListUpdateControllerConfigBuilder : IEntityControllerConfigBuilder
{
    public const string ACTION = "UpdateList";
    private readonly IDbContextProvider _dbContextProvider;
    public string ActionName { get; set; }

    public EntityListUpdateControllerConfigBuilder(IDbContextProvider dbContextProvider, string actionName)
    {
